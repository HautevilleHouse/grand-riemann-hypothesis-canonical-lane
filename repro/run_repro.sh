...
mkdir -p .codex_tmp/grand_riemann_hypothesis
cp artifacts/stitch_constants.json .codex_tmp/grand_riemann_hypothesis/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/grand_riemann_hypothesis/constants_registry.json
