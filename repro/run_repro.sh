...
mkdir -p .tmp/grand_riemann_hypothesis
cp artifacts/stitch_constants.json .tmp/grand_riemann_hypothesis/stitch_constants.json
cp artifacts/constants_registry.json .tmp/grand_riemann_hypothesis/constants_registry.json
